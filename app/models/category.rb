class Category < ApplicationRecord
  NAMES = {
      ...
      "Media": "Web-app.png",
      "Navigation": "Web-app.png",
      "News Tickers": "Web-app.png",
      "Project Management Tools": "Web-app.png",
      "Ratings and Charts": "Web-app.png",
      "Shopping Carts": "Web-app.png",
      "Sliders": "Web-app.png",
      "Social Networks": "Web-app.png",
      ...
      "Tabs and Sliders": "Web-app.png",
      "Canvas": "Web-app.png",
      "Ad Templates": "Web-app.png",
      "Libraries": "Web-app.png",
      "Storage": "Web-app.png",
      "Templates": "Web-app.png",
